...
export default {
  ...
  methods: {
    show (config, parent) {
      ...
      if (item.type === 'create') {
        ...
        dataValue.data = {
          caseId: item.caseId,
          flowCondition: config.parent.flowCondition,
          templateId: '19520478fca04eeeb43a290320196dc6',
          viewType: 'view'
        }
      }
      parent.loading = true
    ...
    getAssList (index, formData) {
      ...
      param.caseNumber = createFormData.caseNumber || ''
    ...
    // 备注
    handleRemarks () {
      const obj = Object.assign(this.$refs.userTableFormView.form.getFieldsValue().record, { caseId: this.config.data.caseId })
