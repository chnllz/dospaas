...
export default {
  ...
  methods: {
    loadDataTable (parameter) {
      return this.axios({
        url: '/callcenter/callRecordSummary/overviewMonth',
        ...
        const arr = []
        this.mychartData.lengend.forEach((item, index) => {
          arr[index] = this.$t(item)
        })
        this.mychartData.lengend = arr
        this.mychartData.series.forEach(item => {
    ...
    panelChangeOne (value) {
      ...
      this.queryParam.searchMonth = this.moment(value).format('YYYY')
