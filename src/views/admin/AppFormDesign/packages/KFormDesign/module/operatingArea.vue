  ...
  <div class="operating-area">
    ...
    <div class="left-btn-box">
      ...
      <a-space>
        ...
        <a-button v-if="!tableType && entranceType === 'appViewDesign'" size="small" @click="$emit('querierFormRule')">
          {{ $t('表单规则') }}
        </a-button>
        ...
        <a-button v-if="entranceType === 'appDataDesign'" size="small" @click="$emit('setFloatBtn')">
          {{ $t('悬浮按钮设置') }}
        </a-button>
        <a-dropdown v-if="!tableType && !['appPageDesign', 'appDataDesign'].includes(entranceType)">
          <a-menu
            slot="overlay"
            @click="
              (e) => {
