<template>
  <a-config-provider :locale="locale">
    <div class="form-designer-container-913607648684152" style="border: 0">
      ...
      >
        <a-form :form="settingForm" :labelCol="{ span: 4 }" :wrapperCol="{ span: 20 }">
          ...
          <a-form-item v-if="userInfo.superAdmin">
            ...
            <a-select v-decorator="['info[accessLevel]', { initialValue: formdata.accessLevel || 0 }]">
...
export default {
  ...
  watch: {
    ...
    setting (val) {
      if (val) {
        this.previewOptions.width = val.templatePreviewWidth ? val.templatePreviewWidth : 1200
        // this.previewOptions.labelWidth = val.labelWidth ? val.labelWidth : 150
      }
    }
  },
  created () {
      ...
      this.settingForm.validateFields((errors, values) => {
        if (!errors) {
          Object.assign(this.formdata, values.info, {
            ...
            // labelWidth: this.previewOptions.labelWidth
          })
