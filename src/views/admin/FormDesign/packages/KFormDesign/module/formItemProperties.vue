  ...
  <div class="properties-centent kk-checkbox">
    ...
    <div class="properties-body">
      <a-form v-show="selectItem.key !== ''">
        ...
        <div v-else>
          <!-- 子表设置start -->
          <a-form-item v-if="selectItem.type === 'web_sub_data_window'" :label="$t('关联数据窗口')">
          ...
          <template v-else-if="selectItem.type === 'web_sub_form_view'">
            ...
            <a-form-item :label="$t('change事件')">
              <a-button @click="codeEditor">
                <a-badge v-if="selectItem.attribute" status="success" :text="$t('设置')" />
...
export default {
  ...
  methods: {
    ...
    subFormShow () {
      // if (!this.selectItem.relationSetting.tableidSon) {
    ...
    setSubTable (data, selectItem) {
      console.log('data', data)
      console.log('selectItem', selectItem)
      this.$set(selectItem, 'relationSetting', data)
    }
  }
}
</script>
