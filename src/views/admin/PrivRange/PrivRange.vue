  ...
  data () {
    return {
      ...
      departSetList: [
        ...
        { value: 'dept', name: this.$t('本部门(不含子部门)'), disabled: false },
        { value: 'subDept', name: this.$t('本部门子部门'), disabled: false },
        { value: 'role', name: this.$t('本角色'), disabled: false },
  ...
  methods: {
    ...
    handleSubmit () {
      ...
      if (this.config.key === 'customAccess') {
        ...
        this.$emit('ok', Object.assign(this.privSetting, { username: this.config.username }))
      }
    }
  }
}
