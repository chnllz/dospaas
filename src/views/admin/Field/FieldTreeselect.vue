      ...
      <a-row type="flex" align="middle">
        ...
        <a-col v-if="optionValue === '0'" :span="20">
          <data-picker
            ...
            displayType="tree"
            :url="
              data.attribute.dataSource === 'addressBook' ? '/admin/address/getAddressChildren' : '/admin/dict/initData'
            "
            :searchUrl="
...
export default {
  ...
  data () {
    return {
      ...
      optionalRange: [],
      custom: [],
      treeSelectRangeKey: 'treeSelectRangeKey_1',
      rangeDataPickerUpdate: 0
    }
  },
  watch: {
    setting: {
      handler (newVal) {
        ...
        this.optionValue = newVal.form.optionRange
        if (this.srcShow) {
          this.axios({
        ...
        this.suffixVal = newVal.form.suffixVal || ''
        ...
        this.optionalRange = this.data.form.optionalRange
      },
      immediate: true
    }
  },
  methods: {
    ...
    getSrc (e) {
      ...
      this.setting.form.optionRange = this.optionValue = '3'
      this.$emit('setFieldsValue', {
        key: 'setting[form][optionRange]',
        value: '3'
      })
      this.rangeDataPickerUpdate++
      // -- 可选范围初始化 --
