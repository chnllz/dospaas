  ...
  <a-form :form="form">
    ...
    <a-form-item :label="$t('数据字典')" :labelCol="labelCol" :wrapperCol="wrapperCol">
      <a-select
        ...
        @change="getCascader"
      >
        <a-select-option v-for="value in srcPath" :key="value.dictCategoryNumber" :value="value.dictCategoryNumber">
    ...
    <a-form-item :label="$t('清空图标')" :labelCol="labelCol" :wrapperCol="wrapperCol">
      <a-switch
        v-decorator="[
          ...
          { initialValue: data.form.clearIcon ? true : false, valuePropName: 'checked' }
        ]"
