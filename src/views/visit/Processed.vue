<template>
  <div class="page">
    ...
    <template v-if="showdata.action === 'waitTask'" size="small" :bordered="false">
      <s-table
        ref="table"
        class="table-fill"
        :scroll="{ y: true }"
    ...
    <template v-if="showdata.action === 'myTask'" size="small" :bordered="false">
      <s-table
        ref="table"
        class="table-fill"
        size="small"
    ...
    <template v-if="showdata.action === 'ProcessedTask'" size="small" :bordered="false">
      <s-table
        ref="table"
        class="table-fill"
        size="small"
    ...
    <template v-if="showdata.action === 'myProcessed'" size="small" :bordered="false">
      <s-table
        ref="table"
        class="table-fill"
        size="small"
