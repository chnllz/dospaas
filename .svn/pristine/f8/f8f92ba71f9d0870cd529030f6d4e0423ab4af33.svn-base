      ...
      this.$confirm({
        ...
        onOk () {
          ...
          if (type === self.$t('单选题')) {
            ...
            const key = self.titleData.indexOf(self.$t('单选题'))
          ...
          if (type === self.$t('多选题')) {
            ...
            const key = self.titleData.indexOf(self.$t('多选题'))
          ...
          if (type === self.$t('判断题')) {
            ...
            const key = self.titleData.indexOf(self.$t('判断题'))
          ...
          if (type === self.$t('填空题')) {
            ...
            const key = self.titleData.indexOf(self.$t('填空题'))
          ...
          if (type === self.$t('简答题')) {
            ...
            const key = self.titleData.indexOf(self.$t('简答题'))
