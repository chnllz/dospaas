  ...
  <div>
    <div v-if="!formConfig.tableType">
      ...
      >
        ...
        <div v-else-if="record.formType === 'colorpicker'">
          <div
            style="
        ...
        <a-textarea v-else-if="record.formType === 'json'" :rows="2" :disabled="record.fieldRule === 'readonly'" />
        <a-date-picker
      ...
      <!-- 子表 -->
      <a-form-item v-else-if="record.type === 'web_sub_form_view'" :label="record.label">
        <a-input :disabled="record.fieldRule === 'readonly'" :placeholder="$t('子表单')">
