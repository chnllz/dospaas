                            ...
                            (value) => {
                              ...
                              fieldArr.forEach((item1) => {
                                if (item1.alias === value) {
                                  ...
                                  } else if (['radio', 'switch', 'combobox', 'score'].indexOf(item1.formType) !== -1) {
                                    simpleItem.conditionArr = [
                                      { enName: 'equal', cnName: $t('等于') },
                                      { enName: 'ne', cnName: $t('不等于') },
                                      { enName: 'em', cnName: $t('为空') },
...
export default {
  ...
  methods: {
    show (config) {
      ...
      console.log('JSON.parse(JSON.stringify(this.theme.viewData))', JSON.parse(JSON.stringify(this.theme.viewData)))
      ...
      if (config.page === 'viewForm') {
        ...
        if (config.record.enableCondition) {
          if (config.record.enableCondition.length !== 0) {
            this.data = config.record.enableCondition !== 0 ? JSON.parse(JSON.stringify(config.record.enableCondition)) : JSON.parse(JSON.stringify(this.initData))
          } else {
      ...
      this.axios({
        ...
        this.fieldArr = res.result.filter(item => {
