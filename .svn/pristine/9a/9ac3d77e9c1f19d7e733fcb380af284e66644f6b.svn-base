  ...
  <div class="page">
    ...
    >
      <div slot="action" slot-scope="text, record">
        <a @click="detailsPage(record)">{{ $t('查看') }}</a>
        <a
      ...
      <div slot="reconside_status" slot-scope="text">
        {{ $t(text) }}
      </div>
    </s-table>
                ...
                <a-form-item>
                  ...
                  >
                    <a-form-item v-for="(items, timestamp, indexs) in item.list" :key="indexs">
                      ...
                      <a-col :span="3">
                        <a-checkbox v-show="keys === 0" :checked="false"></a-checkbox>
    ...
    <apply-reconside ref="ApplyReconside" @ok="handleOk" />
  </div>
</template>
<script>
export default {
  ...
  props: {
    url: {
      type: String,
      default: '/quality/inspected1/mockInit'
    }
  },
  ...
  data () {
    return {
      ...
      columns: [{
        ...
        sorter: true,
        scopedSlots: { customRender: 'reconside_status' }
      }],
      recon: '',
      selectedRowKeys: [],
      rowSelection: {
